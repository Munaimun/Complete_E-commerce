...
const FavoriteProduct = ({ product }: { product: ProductProps }) => {
  ...
  return (
    <div className="flex py-6 w-full text-start">
      ...
      <div
        ...
        className="ml-4 flex-shrink-0 h-20 w-20 sm:w-52 sm:h-40 sm:order-first sm:m-0 sm:mr-6 border border-gray-200 rounded-md hover:border-skyText duration-200 cursor-pointer group overflow-hidden"
      >
        <img
